...
// TODO: import { stubParentPostMessage } from '../../common/postmessage_helper';
const stubParentPostMessage = () => { console.error('fix me'); };
...
describe(['tagdesktop', 'tagnextcloud', 'tagproxy'], 'WOPI app-loaded state across reconnect', function() {
	...
	//
	// TODO: enable in case post message helper will be backported
	it.skip('re-sends Document_Loaded after a reconnect without re-initializing the UI', function() {
