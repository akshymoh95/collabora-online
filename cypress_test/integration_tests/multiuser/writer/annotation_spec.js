...
describe(['tagmultiuser'], 'Multiuser Annotation Tests', function () {
	...
	it('Only author sees Modify', function() {
		...
		cy.cGet('#comment-annotation-menu-1').click();
		cy.cGet('body').contains('.context-menu-item', 'Modify').should('exist');
		cy.cGet('body').contains('.context-menu-item', 'Reply').should('exist');
		...
		cy.cGet('#comment-annotation-menu-1').click();
		cy.cGet('body').contains('.context-menu-item', 'Modify').should('not.exist');
		cy.cGet('body').contains('.context-menu-item', 'Reply').should('exist');
	});
	});
